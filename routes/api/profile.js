...
router.get('/github/:username', (req, res) => {
  try {
    ...
    const options = {
      uri: `https://api.github.com/users/${req.params.username}/repos?per_page=5&sort=created:asc&cliend_id=${config.get('githubClientID')}&client_secret=${config.get('gihubSecret')}`,
      method: 'GET',
